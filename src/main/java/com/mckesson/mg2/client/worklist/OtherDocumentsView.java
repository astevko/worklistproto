 ...
 *
 */
public class OtherDocumentsView extends WorklistView {

    private static OtherDocumentsViewUiBinder uiBinder = GWT.create(OtherDocumentsViewUiBinder.class);

    interface OtherDocumentsViewUiBinder extends UiBinder<Widget, OtherDocumentsView> {
    }
